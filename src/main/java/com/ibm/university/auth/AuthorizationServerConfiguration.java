package com.ibm.university.auth;
...
public class AuthorizationServerConfiguration extends AuthorizationServerConfigurerAdapter {
	...
	@Autowired
	private UserServiceImplemtation userDetailsService;
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		clients.inMemory()
				.withClient("university-client")
				.secret(passwordEncoder.encode("university-secret"))
